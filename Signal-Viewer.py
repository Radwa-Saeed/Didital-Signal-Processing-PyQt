...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        for i in range(0,12):
            ...
            if i ==0:
                ...
                self.equalizers[i].setGeometry(QtCore.QRect(976, 600, 22, 221))
                self.equalizers[i].setObjectName("Spec-min")
                self.equalizers[i].setValue(0)
            else :
                self.equalizers[i].setGeometry(QtCore.QRect(1050, 600, 22, 221))
    ...
    def readsignal(self):
        ...
        # self.fname=QtGui.QFileDialog.getOpenFileName(self,' txt or CSV or xls',"QFileDialog.getOpenFileName()", "","All Files (*);;Python Files (*.py)")
        # self.path=self.fname[0]
        # self.fs,data1=wavfile.read(self.path)
        # # print(data1)
    ...
    def opensignal(self):
        ...
        # arr = np.arange(1 , 126 , 1 )
        # self.array = arr [::-1]
        # logg= 20 * (np.log10(self.array/125)*(-1))

        # self.equalizers[10].setMaximum(int(logg[-1]))
        # self.equalizers[10].setMinimum(int(logg[0]))
        # self.equalizers[11].setMinimum(int(logg[0]))
        # self.equalizers[11].setMaximum(int(logg[-1]))

        # self.equalizers[10].setValue(int(logg[0]))
        # self.equalizers[11].setValue(int(logg[-1]))

        # self.equalizers[10].setSingleStep(int(logg[-1]/5))
        # self.equalizers[11].setSingleStep(int(logg[-1]/5))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(2, _translate("MainWindow", "Accent"))
